...
class SettingsRepository(private val context: Context) {
    ...
    suspend fun updateLastProjectDigestSent(ts: Long) {
        context.dataStore.edit { it[LAST_PROJECT_DIGEST_SENT] = ts }
    }

    suspend fun updateLastIssueDigestSent(ts: Long) {
        context.dataStore.edit { it[LAST_ISSUE_DIGEST_SENT] = ts }
    }
}
